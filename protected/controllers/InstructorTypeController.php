...
class InstructorTypeController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('InstructorType');
	...
	{
		$model=new InstructorType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['InstructorType']))
			$model->attributes=$_GET['InstructorType'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=InstructorType::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='instructor-type-form')
		{
