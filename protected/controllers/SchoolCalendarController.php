...
class SchoolCalendarController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('SchoolCalendar');
	...
	{
		$model=new SchoolCalendar('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SchoolCalendar']))
			$model->attributes=$_GET['SchoolCalendar'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='school-calendar-form')
		{
