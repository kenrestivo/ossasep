...
class RequirementTypeController extends Controller
{
	...
	{
		$model=new RequirementType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RequirementType']))
			$model->attributes=$_GET['RequirementType'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='requirement-type-form')
		{
